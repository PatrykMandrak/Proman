...
def get_connection_data(db_name=None):
    ...
    """
    if db_name is None:
        db_name = os.environ.get('MY_PSQL_DBNAME', 'postman')

    return {
        'dbname': db_name,
        'user': os.environ.get('MY_PSQL_USER', 'postgres'),
        'host': os.environ.get('MY_PSQL_HOST', '127.0.0.1'),
        'password': os.environ.get('MY_PSQL_PASSWORD', 'Spin342351')
    }
